...
# Challenge:  #SWDchallenge 2024 -- August
## Topic:     AUG 2024 | visualize the Olympics
## Author:    Steven Ponce
## Date:      2024-08-02
...
## Data:      120 years of Olympic history: athletes and results
##            basic bio data on athletes and medal results from 
...
pacman::p_load(
  ...
  MoMAColor,   # Color Palettes Inspired by Artwork at the Museum of Modern Art in New York City
...
## 2. READ THE DATA ----
athlete <- read_csv('2024/08_Aug/data/athlete_events.csv') |> clean_names() |> glimpse()
regions <- read_csv('2024/08_Aug/data/noc_regions.csv') |> clean_names() |> glimpse()
...
### |-  titles and caption ----
# icons
tt <- str_glue("#SWDchallenge: AUG 2024 &bull; Source: @rgriffin via Kaggle<br>")  
li <- str_glue("<span style='font-family:fa6-brands'>&#xf08c;</span>")  
gh <- str_glue("<span style='font-family:fa6-brands'>&#xf09b;</span>")
mn <- str_glue("<span style='font-family:fa6-brands'>&#xf4f6;</span>")

# text
title_text   <- str_glue("Streamgraph of Athlete Counts Over Time") 

subtitle_text <- str_glue("Winter and Summer Olympic Games, 1896 - 2016")
...
theme_update(
  ...
  axis.text.x           = element_text(size = rel(1), color = text_col, family = 'text'),
...
### |- annotated plot ----
p +
  # Annotating World War I
  annotate("text", x = 1914, y = 12000, label = "World War I", size = 5, angle = 90, color = "gray30") +
  annotate("rect", xmin = 1914, xmax = 1918, ymin = -Inf, ymax = Inf, alpha = 0.2, fill = "gray30") +
  # Annotating World War II
  annotate("text", x = 1939, y = 12000, label = "World War II", size = 5, angle = 90, color = "gray30") +
  annotate("rect", xmin = 1939, xmax = 1945, ymin = -Inf, ymax = Inf, alpha = 0.2, fill = "gray30") 
