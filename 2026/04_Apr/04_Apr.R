...
## Challenge: #SWDchallenge 2026 -- April
## Topic:     Visualize a Timeline

## Data:      Synthetic / illustrative data — designed to show oncology launch
##            timing dynamics. Not based on any specific product or company.
##            Durations reflect plausible industry ranges for educational purposes.
